...
| 24 Sep 2026 | `34ecf74` | Provider-suppression D-1 production deployment | Pass: exact commit Live; production health HTTP 200 | Initial health probe used wrong `.com` host and was discarded; correct `.co.uk` backend health passed | Deployment identity and immediate backend health | Does not prove suppression population, provider delivery or inbox placement | CT-DEC-022 deployment verification |
| 24 Sep 2026 | production reconciliation / first approved transaction | Transaction abort and rollback verification | Pass: transaction did not commit; immediate dry run remained 0 exact / 815 requiring change / 0 non-exact | Exact post-write comparison exposed BSON millisecond precision loss for 60 Resend timestamps with sub-millisecond source precision | Transaction safety, rollback and failure isolation | Failed attempt intentionally produced no retained subscriber mutation | CT-DEC-022 reconciliation safety evidence |
| 24 Sep 2026 | corrected reconciliation tooling | BSON timestamp normalization and disposable transactional round-trip | Pass: source sub-millisecond condition exercised; normalized millisecond value round-tripped exactly; transaction aborted; zero retained documents | None after correction | Exact MongoDB Date representation used by reconciliation verifier | Disposable test only; does not itself prove subscriber reconciliation | CT-DEC-022 reconciliation correction verification |
| 24 Sep 2026 | production reconciliation / corrected approved transaction | Authoritative Resend suppression reconciliation | Pass: 815 matched / 815 modified / 815 exact post-write / transaction committed | None | Exact-ID transactional population of four provider-suppression fields; 785 bounce / 30 complaint | Local database reconciliation only; no Resend unsuppression, lifecycle/preference change or inbox-delivery claim | CT-DEC-022 production reconciliation |
| 24 Sep 2026 | production post-reconciliation | Independent dry-run and global aggregate verification | Pass: 815 exact / 0 requiring change / 0 non-exact; 815 globally suppressed = 583 active + 232 inactive/legacy; 785 bounce + 30 complaint; 0 unexpected source/reason | None | Committed-state reconciliation and aggregate consistency | Does not prove inbox placement or remediation of Apple/iCloud Junk | CT-DEC-022 post-write verification |
